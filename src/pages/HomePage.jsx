...
const randomQueries = ["pasta", "salad", "dessert", "pizza", "soup", "seafood", "vegan", "breakfast", "snack"];
			...
			<div className='max-w-screen-lg mx-auto'>
				...
				<div className='flex justify-between items-center mt-4'>
					...
					<button
						...
						className='bg-red-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-brown-600 transition-all'>
						Surprise Me!
					</button>
				</div>
